...
namespace Ankh.Scc {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Subversion detected a working copy that needs an explicit upgrade in &apos;{0}&apos;. While this working copy is not upgraded all files in this will appear as new. When a working copy is upgraded it can no longer be used by Subversion clients that weren&apos;t designed for this (or later) working copy formats.
        ///
        ///Further upgrade required warnings are suppressed until you restart Visual Studio..
        /// </summary>
