...
//			explicit StringHelper( String __gc* string )
//			{
//				this->string = string;
//				this->charPtr = 0;
//			}
...
//			explicit StringHelper( const char* charPtr )
//			{
...
//			String*() ToSystemString( apr_pool_t* pool) const
//			{
//				return this->string;
//			}
//
...
//					const char* ansi;
//					Pool pool;
//					HandleError( svn_utf_cstring_from_utf8( &ansi, ptr, pool ) );
//					return Marshal::PtrToStringAnsi( static_cast<IntPtr>(const_cast<char*>(ansi) ) );
//				}
//				else
//					return 0;
//			}
