...
namespace Ankh.VSPackage
{
    ...
    [ProvideToolsOptionsPageVisibility(AnkhSvnPackage.SccOptionGroup, @"Subversion User Tools\Subversion Advanced Merge User Tools", AnkhId.GitSccProviderId)]
    ...
    [ProvideToolsOptionsPageVisibility(AnkhSvnPackage.SccOptionGroup, @"Subversion User Tools\Subversion Advanced Diff User Tools", AnkhId.GitSccProviderId)]
