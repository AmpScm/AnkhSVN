...
namespace Ankh.Diff
{
	...
	public sealed class NumericTextBox : TextBox
	{
		...
		[Browsable(false), ReadOnly(true)] public override string Text { get { return base.Text; } set { base.Text = value; } }
		[Browsable(false), ReadOnly(true)] public override bool Multiline { get { return false; } set { throw new NotSupportedException(); } }
		[Browsable(false), ReadOnly(true)] public new ScrollBars ScrollBars { get { return ScrollBars.None; } set { throw new NotSupportedException(); } }
		[Browsable(false), ReadOnly(true)] public new bool AcceptsReturn { get { return false; } set { throw new NotSupportedException(); } }
		[Browsable(false), ReadOnly(true)] public new bool AcceptsTab { get { return false; } set { throw new NotSupportedException(); } }
		[Browsable(false), ReadOnly(true)] public new string[] Lines { get { return new string[0]; } set { throw new NotSupportedException(); } }
		[Browsable(false), ReadOnly(true)] public new bool WordWrap { get { return false; } set { throw new NotSupportedException(); } }
		[Browsable(false), ReadOnly(true)] public new char PasswordChar { get { return '\0'; } set { throw new NotSupportedException(); } }
