...
#include "../NSvn.Core/NotificationEventArgs.h"
#include "NotificationEventArgsTest.h"
...
void NSvn::Core::Tests::MCpp::NotificationEventArgsTest::TestBasic()
{
    NotificationEventArgs* notification = new NotificationEventArgs( "C:/foo", 
