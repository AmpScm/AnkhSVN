...
namespace Ankh.Diff
{
	...
	public sealed class Utilities
	{
		...
		public static void About(Form frmOwner, string strName, string strVersion)
		{
			AboutBox Dlg = new AboutBox();
			Dlg.Execute(frmOwner, strName, strVersion);
		}
		...
		public static OSStyle OSStyle
		{
			get
			{
				...
				if (OS.Platform == PlatformID.Win32NT)
				{
					...
					{
						return OSStyle.WindowsXP;
					}
					else if (OS.Version >= new Version(5,0))
					{
						return OSStyle.Windows2000;
					}
					else
					{
						return OSStyle.NT4;
