...
namespace Ankh.Diff
{
    ...
    public sealed class TextEditor : TextBox
    {
        ...
        public new ScrollBars ScrollBars { get { return base.ScrollBars; } set { base.ScrollBars = value; } }
        [DefaultValue(true)]
        ...
        [DefaultValue(false)]
        public new bool HideSelection { get { return base.HideSelection; } set { base.HideSelection = value; } }
