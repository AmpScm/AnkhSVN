  ...
  class AuthenticationProviderCollection : ICollection, IList, IEnumerable, ICloneable
	{
        ...
        public static AuthenticationProviderCollection ReadOnly(AuthenticationProviderCollection list)
        {
            if(list==null)
                throw new ArgumentNullException("list");
            return new ReadOnlyAuthenticationProviderCollection(list);
        }
        #endregion
        ...
        protected AuthenticationProviderCollection(Tag t)
        {
            m_array = null;
        }
		#endregion
        ...
        private class SyncAuthenticationProviderCollection : AuthenticationProviderCollection
        {
            #region Implementation (data)
            private AuthenticationProviderCollection m_collection;
            ...
            #region Construction
            internal SyncAuthenticationProviderCollection(AuthenticationProviderCollection list) : base(Tag.Default)
            {
            ...
            public override IAuthenticationProviderCollectionEnumerator GetEnumerator()
            {
                lock(m_root)
            ...
            public override int AddRange(AuthenticationProviderCollection x)
            {
                lock(this.m_root)
        ...
        private class ReadOnlyAuthenticationProviderCollection : AuthenticationProviderCollection
        {
            #region Implementation (data)
            private AuthenticationProviderCollection m_collection;
            #endregion
            ...
            #region Construction
            internal ReadOnlyAuthenticationProviderCollection(AuthenticationProviderCollection list) : base(Tag.Default)
            {
                m_collection = list;
            }
            #endregion
